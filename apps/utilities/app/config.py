...
class Settings:
    ...
    DB_URL: str = os.getenv("DB_URL", "postgresql+psycopg2://postgres:postgres@localhost:5437/utilities")
    ...
    # eBill issuer (aggregator/biller identity in Payments)
    PAYMENTS_EBILL_ISSUER_PHONE: str = os.getenv("PAYMENTS_EBILL_ISSUER_PHONE", FEE_WALLET_PHONE)
    # Rate limiting
    ...
    RATE_LIMIT_REDIS_PREFIX: str = os.getenv("RATE_LIMIT_REDIS_PREFIX", "rl_util")
    # OTP
