...
class Settings:
    ...
    APP_PORT: int = int(os.getenv("APP_PORT", "8094"))
    DB_URL: str = os.getenv(
        "DB_URL",
        "postgresql+psycopg2://postgres:postgres@localhost:5446/livestock",
    )
    ...
    RATE_LIMIT_REDIS_PREFIX: str = os.getenv("RATE_LIMIT_REDIS_PREFIX", "rl_livestock")
    ...
    NOTIFY_REDIS_CHANNEL: str = os.getenv("NOTIFY_REDIS_CHANNEL", "livestock.events")
