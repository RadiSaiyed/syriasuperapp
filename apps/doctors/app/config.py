...
class Settings:
    ...
    DB_URL: str = os.getenv("DB_URL", "postgresql+psycopg2://postgres:postgres@localhost:5442/doctors")
    ...
    RATE_LIMIT_REDIS_PREFIX: str = os.getenv("RATE_LIMIT_REDIS_PREFIX", "rl_doctors")
    # Notifications + Webhooks
    NOTIFY_MODE: str = os.getenv("NOTIFY_MODE", "log")  # log|redis
    NOTIFY_REDIS_CHANNEL: str = os.getenv("NOTIFY_REDIS_CHANNEL", "doctors.events")
