...
def dev_login(payload: DevLoginIn, db: Session = Depends(get_db)):
    ...
    users = {
        ...
        # Optional role-like aliases for testing
        "rider": {"password": "rider", "phone": "+963901100101", "name": "Dev Rider"},
        "operator": {"password": "operator", "phone": "+963901100201", "name": "Dev Operator"},
    }
