...
echo "Applying deep-link launch whitelist for Bus app (iOS)..."
...
PY
  ...
  echo "! Info.plist not found. Run: flutter create . inside bus_flutter first."
fi

echo "Applying Android queries visibility for Bus app (Android)..."
...
if [[ -f "$ANDROID_MANIFEST" ]]; then
  ...
  echo "! AndroidManifest.xml not found. Run: flutter create . inside bus_flutter first."
fi
