...
class _AppState extends State<App> {
  ...
  int _tab = 0;
  static const _baseUrlKey = 'bus_base_url';
    ...
    return MaterialApp(
      ...
      home: FutureBuilder<String?>(
        ...
        builder: (context, snap) {
          ...
          return Scaffold(
            appBar: AppBar(title: const Text('Bus MVP'), actions: [
              IconButton(
                ...
                onPressed: () async {
                  ...
                  final url = await showDialog<String>(
                    ...
                    builder: (_) => AlertDialog(
                      ...
                      content: TextField(controller: ctrl, decoration: const InputDecoration(hintText: 'http://localhost:8082')),
                      actions: [
