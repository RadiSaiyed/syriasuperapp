...
echo "Applying deep-link launch whitelist for Car Market app (iOS)..."
...
PY
  ...
  echo "! Info.plist not found. Run: flutter create . inside carmarket_flutter first."
fi

echo "Applying Android queries visibility for Car Market app (Android)..."
...
if [[ -f "$ANDROID_MANIFEST" ]]; then
  ...
  echo "! AndroidManifest.xml not found. Run: flutter create . inside carmarket_flutter first."
fi
