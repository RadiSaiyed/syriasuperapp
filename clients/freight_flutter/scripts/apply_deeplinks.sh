...
echo "Applying deep-link launch whitelist for Freight app (iOS)..."
...
PY
  ...
  echo "! Info.plist not found. Run: flutter create . inside freight_flutter first."
fi

echo "Applying Android queries visibility for Freight app (Android)..."
...
if [[ -f "$ANDROID_MANIFEST" ]]; then
  ...
  echo "! AndroidManifest.xml not found. Run: flutter create . inside freight_flutter first."
fi
