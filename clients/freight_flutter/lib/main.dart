...
class _AppState extends State<App> {
  ...
  late ApiClient _api;
  String _baseUrl = 'http://localhost:8085';
  static const _baseUrlKey = 'freight_base_url';
    ...
    return MaterialApp(
      ...
      home: FutureBuilder<String?>(
        ...
        builder: (context, snap) {
          ...
          return Scaffold(
            appBar: AppBar(title: const Text('Freight MVP'), actions: [
              IconButton(
                ...
                onPressed: () async {
                  ...
                  final url = await showDialog<String>(
                    ...
                    builder: (_) => AlertDialog(
                      ...
                      content: TextField(controller: ctrl, decoration: const InputDecoration(hintText: 'http://localhost:8085')),
                ...
                ? Column(children: [
                    Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                      ...
                      DropdownButton<String>(
                        value: _role,
                        items: const [DropdownMenuItem(value: 'shipper', child: Text('Shipper')), DropdownMenuItem(value: 'carrier', child: Text('Carrier'))],
                        onChanged: (v) => setState(() => _role = v ?? 'shipper'),
                      ),
                    ]),
                    Expanded(child: _role == 'shipper' ? ShipperScreen(api: _api) : CarrierScreen(api: _api)),
                  ])
