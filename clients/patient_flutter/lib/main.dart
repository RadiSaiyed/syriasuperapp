...
class _AppState extends State<App> {
  ...
  static const _baseUrlKey = 'patient_base_url';
    ...
    return MaterialApp(
      ...
      home: FutureBuilder<String?>(
        ...
        builder: (context, snap) {
          ...
          return Scaffold(
            appBar: AppBar(title: const Text('Patient'), actions: [
              IconButton(
            ...
            body: loggedIn ? PatientScreen(api: _api) : LoginScreen(api: _api, onLoggedIn: () => setState(() {})),
          );
        },
      ),
    );
