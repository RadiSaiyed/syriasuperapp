...
echo "Applying deep-link launch whitelist for Taxi app (iOS)..."
...
PY
  ...
  echo "! Info.plist not found. Run: flutter create . inside taxi_flutter first."
fi

echo "Applying Android queries visibility for Taxi app (Android)..."
...
if [[ -f "$ANDROID_MANIFEST" ]]; then
  ...
  echo "! AndroidManifest.xml not found. Run: flutter create . inside taxi_flutter first."
fi
